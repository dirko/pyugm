...
class TestFactor(unittest.TestCase):
    def test_marginalize_small_edge(self):
        ...
        assert_array_almost_equal(b.get_data(), a.get_data())
        ...
        assert_array_almost_equal(c.get_data(), a.get_data())
    ...
    def test_marginalize_small(self):
        ...
        assert_array_almost_equal(d.get_data(), e.get_data())
    ...
    def test_set_evidence_not_normalized_not_inplace(self):
        ...
        assert_array_almost_equal(c.get_data(), b.get_data())
